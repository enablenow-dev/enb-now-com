...
const FAQSection: React.FC<FAQSectionProps> = ({ 
  title, 
  subtitle = "Our approach integrates industry knowledge, meticulous attention to detail, and a strong focus on customer needs. We work together with you to guarantee alignment with your business objectives and produce actual results.",
  faqs 
}) => {
